...
namespace GoWorldUnity3D
{
    class Proto
    {
        ...
        internal const UInt16 MT_CREATE_ENTITY_SOMEWHERE = 7;
        internal const UInt16 MT_LOAD_ENTITY_SOMEWHERE = 8;
        ...
        internal const UInt16 MT_QUERY_SPACE_GAMEID_FOR_MIGRATE = 18;
        internal const UInt16 MT_CANCEL_MIGRATE = 19;
        // Message types for migrating
        internal const UInt16 MT_CALL_NIL_SPACES = 20;
        internal const UInt16 MT_SET_GAME_ID_ACK = 21;
        internal const UInt16 MT_NOTIFY_GAME_CONNECTED = 22;
        internal const UInt16 MT_NOTIFY_GAME_DISCONNECTED = 23;
        internal const UInt16 MT_NOTIFY_DEPLOYMENT_READY = 24;
        internal const UInt16 MT_GAME_LBC_INFO = 25;
